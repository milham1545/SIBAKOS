    ...
    <section id="hero" class="hero section dark-background">
        ...
        <div class="container">
            ...
            <div class="col-lg-6  d-flex flex-column justify-content-center" data-aos="fade-in">
                ...
                <div class="d-flex">
                <a href="Order.php" class="btn" style="--clr:#39FF14"><span>PESAN SEKARANG</span><i></i></a>
                <a href="Katalog.php" class="btn" style="--clr:#0FF0FC"><span>Lihat Katalog</span><i></i></a>
                </div>
            </div>
        ...
        <section id="pricing" class="pricing section">
            ...
            <div class="container">
                ...
                <div class="pesan-container text-center mt-4" data-aos="fade-up" data-aos-delay="500">
                    <button class="pesan-arounder" onclick="location.href='Order.php'">PESAN SEKARANG</button>
                </div>
                <!-- End Order Button -->
...
<?php endif; ?><?php /**PATH D:\Berkas Kuliah\Tugas Kuliah\Semester 3\Sistem Informasi\WEBSITE BENERAN\laravel11\resources\views/home.blade.php ENDPATH**/ ?>