        ...
        <?php $__empty_1 = true; $__currentLoopData = $catalogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catalog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="col-md-4">
                <div class="card" style="width: 18rem; margin-bottom: 20px;">
                    <!-- Menampilkan gambar -->
                    <img class="card-img-top" src="<?php echo e(asset('storage').'/'.$catalog['gambar_rambut']); ?>" >
                    <div class="card-body">
                        <!-- Menampilkan judul  -->
...
<?php endif; ?><?php /**PATH D:\Berkas Kuliah\Tugas Kuliah\Semester 3\Sistem Informasi\WEBSITE BENERAN\laravel11 - backup\resources\views/catalogs.blade.php ENDPATH**/ ?>