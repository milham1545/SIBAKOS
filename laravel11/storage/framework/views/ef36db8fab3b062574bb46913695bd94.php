                ...
                <header class="mb-4 lg:mb-6 not-format">
                    ...
                    <address class="flex items-center my-6 not-italic">
                        <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                            ...
                            <div>
                                <a href="<?php echo e($post->author->username); ?>" rel="author" class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e($post->author->name); ?></a>
                                <p class="text-base text-gray-500 dark:text-gray-400 mb-1"><?php echo e($post->created_at->diffForHumans()); ?></p>
                                <a href="/categories/<?php echo e($post->category->slug); ?>" class="hover:underline">
