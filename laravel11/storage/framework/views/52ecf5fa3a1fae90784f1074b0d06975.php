          ...
          <form method="post" action="/reservation" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-12 col-md-6">
                ...
                <div class="mb-3">
                  <label for="gambar_referensi" class="form-label">Referensi Gaya Rambut</label>
                  <input class="form-control" type="file" name="gambar_referensi" id="gambar_referensi" required>
                </div>
...
<?php endif; ?><?php /**PATH D:\Berkas Kuliah\Tugas Kuliah\Semester 3\Sistem Informasi\WEBSITE BENERAN\laravel11 - backup\resources\views/reservation/index.blade.php ENDPATH**/ ?>